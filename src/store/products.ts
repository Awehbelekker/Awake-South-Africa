...
const flattenProducts = (): EditableProduct[] => {
  const allProducts = [
    ...
    ...(DEFAULT_PRODUCTS as any).jetpackBundles || [],
    ...DEFAULT_PRODUCTS.limitedEdition,
    ...DEFAULT_PRODUCTS.efoils,
    ...DEFAULT_PRODUCTS.batteries,
    ...DEFAULT_PRODUCTS.boardsOnly,
    ...(DEFAULT_PRODUCTS as any).jetpackStandalone || [],
    ...(DEFAULT_PRODUCTS as any).accessories || [],
    ...(DEFAULT_PRODUCTS as any).efoilAccessories || [],
