    ...
    <main className="min-h-screen bg-awake-black">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
        ...
        <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16 sm:mb-32">
          ...
          <div className="flex flex-wrap justify-center gap-4 md:gap-12 text-sm text-gray-300 mb-16">
      ...
      {/* WhatsApp CTA strip */}
      <section className="bg-green-600/10 border-y border-green-500/20 py-4 px-4">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-sm text-gray-300 text-center sm:text-left">
            <span className="font-semibold text-white">Questions about which board suits you?</span>{' '}
            <span className="hidden sm:inline">Our team replies within minutes.</span>
          </p>
          <a
            href={`https://wa.me/${SA_CONTENT.contact.whatsapp.replace(/[^0-9]/g, '')}?text=${encodeURIComponent('Hi, I\'d like help choosing the right Awake board for me.')}`}
            target="_blank"
            rel="noopener noreferrer"
            className="flex-shrink-0 flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white px-5 py-2 rounded-full text-sm font-semibold transition-colors"
          >
