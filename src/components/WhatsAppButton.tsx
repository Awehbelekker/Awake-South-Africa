...
export default function WhatsAppButton() {
  const number = SA_CONTENT.contact.whatsapp.replace(/[^0-9]/g, '')
  const message = encodeURIComponent('Hi, I\'m interested in an Awake electric surfboard. Can you help me?')
